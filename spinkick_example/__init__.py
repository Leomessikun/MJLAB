...
gym.register(
  id="Mjlab-Spinkick-Unitree-G1-Train",
  entry_point="mjlab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
    "env_cfg_entry_point": f"{__name__}.spinkick_env_cfg:G1SpinkickCfg_TRAIN",
    "rl_cfg_entry_point": f"{__name__}.spinkick_env_cfg:G1SpinkickPPORunnerCfg",
  },
)
